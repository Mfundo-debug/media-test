...
selected_publications = st.multiselect('Select Publications', ['ST', 'BL', 'FM', 'BD'], default=['ST', 'BL', 'FM', 'BD'])
selected_types = st.multiselect('Select Types', ['Corporate', 'Individual'], default=['Corporate', 'Individual'])
selected_methods = st.multiselect('Select Methods', ['Digital', 'Print'], default=['Digital', 'Print'])
